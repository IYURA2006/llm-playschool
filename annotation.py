...
import db
# The questions themselves live in questions.py — data only, with a
# --check/--show CLI. They are re-exported here because every other
# module reads them off annotation.
