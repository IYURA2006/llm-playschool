...
.turn-comment textarea::placeholder { color: black !important; }
...
# Force dark mode so the hardcoded dark UI never gets recolored grey by the light theme
force_dark = """
() => {
...
with gr.Blocks(js=force_dark) as app:
...
app.launch(css=css, theme=gr.themes.Soft(), share = True)
