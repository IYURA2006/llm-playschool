...
DATA_PATH = os.path.join(_dir, "games/hot_air_balloon/air_balloon_survival_en_complexity_easy/instance_00000", "interactions.json")
OUTPUT_PATH = os.path.join(_dir, "interactions", "annotations-4.json")
games/hot_air_balloon/air_balloon_survival_en_complexity_easy/instance_00000/interactions.json
